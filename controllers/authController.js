...
function renderRegister(res, { error = null, info = null, status = 200 }) {
...
exports.postLogin = async (req, res) => {
  // TODO: kiểm tra user + session
  return res.redirect('/?msg=login_ok');
};
...
exports.getRegister = (req, res) => {
  return renderRegister(res, { error: null, info: null });
};
...
exports.postRegister = async (req, res) => {
  ...
  try {
    ...
    const shippingAddress = buildShippingAddress({ fullName, street, district, city });
